...
<jsp:include page="header.jsp"></jsp:include>
    ...
    <div class="container">
        ...
        <a class="btn btn-primary" style="background-color: #007bff; margin-top: 20px;" href="Home">Trở về</a>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="card mt-3">
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        if(requests == null){
                        %>
                        <a href="teacher-request.jsp" style="text-decoration: none;"><h5 class="text-primary">Nâng cấp tài khoản</h5></a>
