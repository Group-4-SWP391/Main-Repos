    ...
    <body>
        ...
        <div class="content">
            <div class="d-flex justify-content-between align-items-center p-2">
                <a class="btn btn-primary" style="background-color: ; margin-top: 20px; margin-left: 5%" href="Home">Trở về</a>
                <a class="btn btn-primary" style="background-color: ; margin-top: 20px; margin-right: 5%" href="${pageContext.request.contextPath}/MySectionsController" >
                    Học phần của bạn
                </a>
            </div>
