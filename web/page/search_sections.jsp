...
<html>
    ...
    <body>
        ...
        <div class="content">
            <a class="btn btn-primary" style="background-color: ; margin-top: 20px; margin-left: 5%" href="${pageContext.request.contextPath}/SectionsController?action=get">Trở về</a>
