...
<div class="container-xxl py-5">
    ...
    <button class="btn btn-light">
        <a href="view-all-exam.jsp" style="text-decoration: none; color: Black">Trở về</a>
    </button>
    <% } else { %>
    <!-- Nếu user.role != 1 -->
    <button class="btn btn-light">
        <a href="Home" style="text-decoration: none; color: Black">Trở về</a>
    </button>
    <% } %>
